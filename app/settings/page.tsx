...
const COPY = {
  ar: {
    ...
    data: "البيانات", dataDesc: "كل البيانات محفوظة محلياً على جهازك فقط (IndexedDB) — لا شيء يُرسل لأي خادم إلا عند تشغيل التحليل بالذكاء الاصطناعي.",
    backup: "تنزيل نسخة احتياطية (JSON)", conflictsCount: "نزاع محفوظ",
    danger: "منطقة الخطر", dangerDesc: "حذف جميع النزاعات والبيانات المرتبطة بها من هذا الجهاز نهائياً. لا يمكن التراجع عن هذا الإجراء.",
  ...
  en: {
    ...
    arabic: "العربية", english: "English",
    data: "Data", dataDesc: "All data is stored locally on your device only (IndexedDB) — nothing is sent to any server except when running AI analysis.",
    backup: "Download Backup (JSON)", conflictsCount: "conflicts stored",
    danger: "Danger Zone", dangerDesc: "Permanently delete all conflicts and related data from this device. This cannot be undone.",
